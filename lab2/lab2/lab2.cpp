...
/*завести массив с найденными решениями и завести глубину
а строить путь по вершину у которой самая малеькая глубина*/
int main()
{
